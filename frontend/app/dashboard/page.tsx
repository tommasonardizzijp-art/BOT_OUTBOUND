...
// Dashboard aggregata di Instagram (stats, health, timeline, activity feed).
// Prima del Task 9 viveva a "/": spostata qui verbatim quando "/" e' diventato
// il redirect verso il picker di canale (frontend/app/canale/page.tsx), cosi'
// il nav "Dashboard" (components/layout/Sidebar.tsx) continua a mostrare
// esattamente quello che mostrava prima -- nessun contenuto perso, solo
