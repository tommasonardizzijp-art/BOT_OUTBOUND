...
| `wa_campaign_contacts`: `status` runtime, `current_step`, `next_action_at` runtime, `failure_count`, `last_error` | ✅ solo il **seeding iniziale** di `next_action_at` (§7.2) | ✅ tutto il resto | |
